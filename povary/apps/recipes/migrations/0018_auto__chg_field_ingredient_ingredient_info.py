...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('recipes_ingredient', 'ingredient_info_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ingredients.USAIngredient']))
    ...
    models = {
        ...
        'recipes.recipe': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 5, 30, 0, 0)'}),
