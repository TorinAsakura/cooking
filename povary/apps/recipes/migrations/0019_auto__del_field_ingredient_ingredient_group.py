...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Ingredient.ingredient_group'
        db.delete_column('recipes_ingredient', 'ingredient_group_id')

    def backwards(self, orm):
        # Adding field 'Ingredient.ingredient_group'
        db.add_column('recipes_ingredient', 'ingredient_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recipes.IngredientGroup'], null=True, blank=True),
                      keep_default=False)
