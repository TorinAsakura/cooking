...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IngredientInfo.fat_measure'
        db.add_column('recipes_ingredientinfo', 'fat_measure',
                      self.gf('django.db.models.fields.CharField')(default='mgramm', max_length=255),
                      keep_default=False)

        # Adding field 'IngredientInfo.protein_measure'
        db.add_column('recipes_ingredientinfo', 'protein_measure',
                      self.gf('django.db.models.fields.CharField')(default='mgramm', max_length=255),
                      keep_default=False)

        # Adding field 'IngredientInfo.carbs_measure'
        db.add_column('recipes_ingredientinfo', 'carbs_measure',
                      self.gf('django.db.models.fields.CharField')(default='mgramm', max_length=255),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'IngredientInfo.fat_measure'
        db.delete_column('recipes_ingredientinfo', 'fat_measure')

        # Deleting field 'IngredientInfo.protein_measure'
        db.delete_column('recipes_ingredientinfo', 'protein_measure')

        # Deleting field 'IngredientInfo.carbs_measure'
        db.delete_column('recipes_ingredientinfo', 'carbs_measure')
    ...
    models = {
        ...
        'recipes.recipe': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 5, 14, 0, 0)'}),
