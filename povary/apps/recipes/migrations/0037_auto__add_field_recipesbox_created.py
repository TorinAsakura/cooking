...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RecipesBox.created'
        db.add_column('recipes_recipesbox', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 7, 24, 0, 0), blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'RecipesBox.created'
        db.delete_column('recipes_recipesbox', 'created')
    ...
    models = {
        ...
        'recipes.recipe': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 7, 24, 0, 0)'}),
            'published': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
