...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Vitamin.object_id'
        db.delete_column('recipes_vitamin', 'object_id')

        # Deleting field 'Vitamin.content_type'
        db.delete_column('recipes_vitamin', 'content_type_id')

        # Adding field 'Vitamin.ingredient_info'
        db.add_column('recipes_vitamin', 'ingredient_info',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['recipes.IngredientInfo']),
                      keep_default=False)

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Vitamin.object_id'
        raise RuntimeError("Cannot reverse this migration. 'Vitamin.object_id' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Vitamin.content_type'
        raise RuntimeError("Cannot reverse this migration. 'Vitamin.content_type' and its values cannot be restored.")
        # Deleting field 'Vitamin.ingredient_info'
        db.delete_column('recipes_vitamin', 'ingredient_info_id')
    ...
    models = {
        ...
        'recipes.recipe': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 5, 15, 0, 0)'}),
