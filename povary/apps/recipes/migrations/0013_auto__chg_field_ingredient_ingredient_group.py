...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ingredient.ingredient_group'
        db.alter_column('recipes_ingredient', 'ingredient_group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recipes.IngredientGroup'], null=True))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Ingredient.ingredient_group'
        raise RuntimeError("Cannot reverse this migration. 'Ingredient.ingredient_group' and its values cannot be restored.")
    models = {
        'auth.group': {
