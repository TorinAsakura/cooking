...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Recipe.satiety'
        db.delete_column('recipes_recipe', 'satiety')

    def backwards(self, orm):
        # Adding field 'Recipe.satiety'
        db.add_column('recipes_recipe', 'satiety',
    ...
    models = {
        ...
        'recipes.recipe': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 7, 11, 0, 0)'}),
            'published': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
