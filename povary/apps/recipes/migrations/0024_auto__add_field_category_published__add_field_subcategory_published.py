...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('recipes_category', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'SubCategory.published'
        db.add_column('recipes_subcategory', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Category.published'
        db.delete_column('recipes_category', 'published')

        # Deleting field 'SubCategory.published'
        db.delete_column('recipes_subcategory', 'published')
