...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WishedRecipes'
        db.create_table(u'recipes_wishedrecipes', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('recipe', self.gf('django.db.models.fields.related.ForeignKey')(related_name='wished_set', to=orm['recipes.Recipe'])),
            ('cook', self.gf('django.db.models.fields.related.ForeignKey')(related_name='wished_set', to=orm['profiles.Profile'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'recipes', ['WishedRecipes'])


    def backwards(self, orm):
        # Deleting model 'WishedRecipes'
        db.delete_table(u'recipes_wishedrecipes')
    ...
    models = {
        ...
        u'recipes.recipe': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 27, 0, 0)'}),
            'published': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
