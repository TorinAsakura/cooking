...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RecipesBox.is_public'
        db.add_column('recipes_recipesbox', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RecipesBox.published'
        db.add_column('recipes_recipesbox', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'RecipesBox.is_public'
        db.delete_column('recipes_recipesbox', 'is_public')

        # Deleting field 'RecipesBox.published'
        db.delete_column('recipes_recipesbox', 'published')
    ...
    models = {
        ...
        'recipes.recipe': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 24, 0, 0)'}),
            'published': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
