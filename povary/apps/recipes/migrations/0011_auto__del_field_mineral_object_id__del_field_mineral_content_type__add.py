...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Mineral.object_id'
        db.delete_column('recipes_mineral', 'object_id')

        # Deleting field 'Mineral.content_type'
        db.delete_column('recipes_mineral', 'content_type_id')

        # Adding field 'Mineral.ingredient_info'
        db.add_column('recipes_mineral', 'ingredient_info',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['recipes.IngredientInfo']),
                      keep_default=False)

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Mineral.object_id'
        raise RuntimeError("Cannot reverse this migration. 'Mineral.object_id' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Mineral.content_type'
        raise RuntimeError("Cannot reverse this migration. 'Mineral.content_type' and its values cannot be restored.")
        # Deleting field 'Mineral.ingredient_info'
        db.delete_column('recipes_mineral', 'ingredient_info_id')
