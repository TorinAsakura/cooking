...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('recipes_recipe', 'title', self.gf('django.db.models.fields.CharField')(max_length=245))
    def backwards(self, orm):

        # Changing field 'Recipe.title'
        db.alter_column('recipes_recipe', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))
    models = {
        'auth.group': {
        ...
        'recipes.recipe': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'max_length': '245'}),
