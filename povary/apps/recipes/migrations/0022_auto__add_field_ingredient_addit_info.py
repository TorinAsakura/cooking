...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ingredient.addit_info'
        db.add_column('recipes_ingredient', 'addit_info',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Ingredient.addit_info'
        db.delete_column('recipes_ingredient', 'addit_info')
    ...
    models = {
        ...
        'recipes.recipe': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 11, 0, 0)'}),
            'published': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
