...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('recipes_ingredientgroup', (
        ...
        db.add_column('recipes_ingredient', 'ingredient_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['recipes.IngredientGroup']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'IngredientGroup'
        db.delete_table('recipes_ingredientgroup')
