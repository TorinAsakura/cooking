...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Recipe.prepare_time'
        db.delete_column('recipes_recipe', 'prepare_time')

        # Adding field 'Recipe.prepare_time_from'
        db.add_column('recipes_recipe', 'prepare_time_from',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Recipe.prepare_time_to'
        db.add_column('recipes_recipe', 'prepare_time_to',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Recipe.prepare_time'
        db.add_column('recipes_recipe', 'prepare_time',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Recipe.prepare_time_from'
        db.delete_column('recipes_recipe', 'prepare_time_from')

        # Deleting field 'Recipe.prepare_time_to'
        db.delete_column('recipes_recipe', 'prepare_time_to')
    ...
    models = {
        ...
        'recipes.ingredient': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ingredient_group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['recipes.IngredientGroup']", 'null': 'True', 'blank': 'True'}),
        ...
        'recipes.recipe': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 5, 29, 0, 0)'}),
