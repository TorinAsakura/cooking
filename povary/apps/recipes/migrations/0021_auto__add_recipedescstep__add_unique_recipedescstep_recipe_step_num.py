...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RecipeDescStep'
        db.create_table('recipes_recipedescstep', (
        ...
        db.send_create_signal('recipes', ['RecipeDescStep'])

        # Adding unique constraint on 'RecipeDescStep', fields ['recipe', 'step_num']
        db.create_unique('recipes_recipedescstep', ['recipe_id', 'step_num'])

    def backwards(self, orm):
        # Removing unique constraint on 'RecipeDescStep', fields ['recipe', 'step_num']
        db.delete_unique('recipes_recipedescstep', ['recipe_id', 'step_num'])

        # Deleting model 'RecipeDescStep'
        db.delete_table('recipes_recipedescstep')
    ...
    models = {
        ...
        'recipes.recipe': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 5, 0, 0)'}),
        ...
        'recipes.recipedescstep': {
            'Meta': {'unique_together': "(('recipe', 'step_num'),)", 'object_name': 'RecipeDescStep'},
            'description': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('filebrowser.fields.FileBrowseField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'recipe': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['recipes.Recipe']"}),
