...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        for obj in orm.Recipe.objects.exclude(cuisine=None):
            obj.cuisine_new.add(obj.cuisine)
            obj.save()


    def backwards(self, orm):
        # Removing M2M table for field cuisine_new on 'Recipe'
        db.delete_table(db.shorten_name(u'recipes_recipe_cuisine_new'))
    ...
    models = {
        ...
        u'recipes.recipe': {
            ...
            'cuisine_new': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'recipes'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['recipes.Cuisine']"}),
