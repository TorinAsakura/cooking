...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_unique('recipes_recipe_cuisine_new', ['recipe_id', 'cuisine_id'])

        db.rename_table('recipes_recipe_cuisine_new', 'recipes_recipe_cuisine')
        db.create_unique('recipes_recipe_cuisine', ['recipe_id', 'cuisine_id'])

    def backwards(self, orm):
        # Adding M2M table for field cuisine_new on 'Recipe'
        m2m_table_name = db.shorten_name(u'recipes_recipe_cuisine_new')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('recipe', models.ForeignKey(orm[u'recipes.recipe'], null=False)),
            ('cuisine', models.ForeignKey(orm[u'recipes.cuisine'], null=False))
        ))
        db.create_unique(m2m_table_name, ['recipe_id', 'cuisine_id'])

        # Removing M2M table for field cuisine on 'Recipe'
        db.delete_table(db.shorten_name(u'recipes_recipe_cuisine'))
    ...
    models = {
        ...
        u'recipes.ingredient': {
            ...
            'measure': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        u'recipes.recipe': {
            ...
            'cuisine': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'recipes'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['recipes.Cuisine']"}),
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 28, 0, 0)'}),
            'published': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
