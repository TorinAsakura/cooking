...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Ingredient', fields ['ingredient_info']
        db.delete_unique('recipes_ingredient', ['ingredient_info_id'])


        # Changing field 'Ingredient.ingredient_info'
        db.alter_column('recipes_ingredient', 'ingredient_info_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recipes.IngredientInfo']))
    def backwards(self, orm):

        # Changing field 'Ingredient.ingredient_info'
        db.alter_column('recipes_ingredient', 'ingredient_info_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['recipes.IngredientInfo'], unique=True))
        # Adding unique constraint on 'Ingredient', fields ['ingredient_info']
        db.create_unique('recipes_ingredient', ['ingredient_info_id'])
