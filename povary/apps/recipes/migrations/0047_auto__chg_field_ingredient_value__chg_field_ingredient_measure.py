...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ingredient.value'
        db.alter_column(u'recipes_ingredient', 'value', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Ingredient.measure'
        db.alter_column(u'recipes_ingredient', 'measure', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Ingredient.value'
        db.alter_column(u'recipes_ingredient', 'value', self.gf('django.db.models.fields.FloatField')(default=datetime.datetime(2014, 1, 22, 0, 0)))

        # Changing field 'Ingredient.measure'
        db.alter_column(u'recipes_ingredient', 'measure', self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2014, 1, 22, 0, 0), max_length=255))
    ...
    models = {
        ...
        u'recipes.recipe': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 22, 0, 0)'}),
            'published': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
