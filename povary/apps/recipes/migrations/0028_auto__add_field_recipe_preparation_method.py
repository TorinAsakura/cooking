...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recipe.preparation_method'
        db.add_column('recipes_recipe', 'preparation_method',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='recipes', null=True, to=orm['recipes.PrepMethod']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Recipe.preparation_method'
        db.delete_column('recipes_recipe', 'preparation_method_id')
    ...
    models = {
        ...
        'recipes.recipe': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 7, 4, 0, 0)'}),
            'published': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
