...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'recipes_recipe', 'cuisine_id')


    def backwards(self, orm):
        # Adding field 'Recipe.cuisine'
        db.add_column(u'recipes_recipe', 'cuisine',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recipes.Cuisine'], null=True, blank=True),
                      keep_default=False)
