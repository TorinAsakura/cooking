...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'USAIngredient.published'
        db.add_column('ingredients_usaingredient', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'USAIngredient.published'
        db.delete_column('ingredients_usaingredient', 'published')
