...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'USAIngredient', fields ['ndb_no']
        db.create_unique('ingredients_usaingredient', ['ndb_no'])

    def backwards(self, orm):
        # Removing unique constraint on 'USAIngredient', fields ['ndb_no']
        db.delete_unique('ingredients_usaingredient', ['ndb_no'])
