...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'USAIngredient.updatable'
        db.add_column('ingredients_usaingredient', 'updatable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'USAIngredient.updatable'
        db.delete_column('ingredients_usaingredient', 'updatable')
