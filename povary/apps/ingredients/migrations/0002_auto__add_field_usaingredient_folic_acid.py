...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'USAIngredient.folic_acid'
        db.add_column('ingredients_usaingredient', 'folic_acid',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'USAIngredient.folic_acid'
        db.delete_column('ingredients_usaingredient', 'folic_acid')
