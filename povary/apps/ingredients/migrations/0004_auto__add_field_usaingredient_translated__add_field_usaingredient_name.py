...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'USAIngredient.translated'
        db.add_column('ingredients_usaingredient', 'translated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'USAIngredient.name_rus'
        db.add_column('ingredients_usaingredient', 'name_rus',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'USAIngredient.translated'
        db.delete_column('ingredients_usaingredient', 'translated')

        # Deleting field 'USAIngredient.name_rus'
        db.delete_column('ingredients_usaingredient', 'name_rus')
