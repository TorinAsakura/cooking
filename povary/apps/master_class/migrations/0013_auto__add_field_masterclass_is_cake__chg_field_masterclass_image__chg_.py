...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MasterClass.is_cake'
        db.add_column(u'master_class_masterclass', 'is_cake',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'MasterClass.image'
        db.alter_column(u'master_class_masterclass', 'image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))

        # Changing field 'CategoryMC.image'
        db.alter_column(u'master_class_categorymc', 'image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))

        # Changing field 'MCStep.image'
        db.alter_column(u'master_class_mcstep', 'image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))

        # Changing field 'SubCategoryMC.image'
        db.alter_column(u'master_class_subcategorymc', 'image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))

    def backwards(self, orm):
        # Deleting field 'MasterClass.is_cake'
        db.delete_column(u'master_class_masterclass', 'is_cake')


        # Changing field 'MasterClass.image'
        db.alter_column(u'master_class_masterclass', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

        # Changing field 'CategoryMC.image'
        db.alter_column(u'master_class_categorymc', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

        # Changing field 'MCStep.image'
        db.alter_column(u'master_class_mcstep', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

        # Changing field 'SubCategoryMC.image'
        db.alter_column(u'master_class_subcategorymc', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
