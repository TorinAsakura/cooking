...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CategoryMC.created'
        db.add_column('master_class_categorymc', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 8, 2, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'CategoryMC.updated'
        db.add_column('master_class_categorymc', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 8, 2, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'SubCategoryMC.created'
        db.add_column('master_class_subcategorymc', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 8, 2, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'SubCategoryMC.updated'
        db.add_column('master_class_subcategorymc', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 8, 2, 0, 0), blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'CategoryMC.created'
        db.delete_column('master_class_categorymc', 'created')

        # Deleting field 'CategoryMC.updated'
        db.delete_column('master_class_categorymc', 'updated')

        # Deleting field 'SubCategoryMC.created'
        db.delete_column('master_class_subcategorymc', 'created')

        # Deleting field 'SubCategoryMC.updated'
        db.delete_column('master_class_subcategorymc', 'updated')
