...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CategoryMC.is_cake'
        db.add_column(u'master_class_categorymc', 'is_cake',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CategoryMC.is_cake'
        db.delete_column(u'master_class_categorymc', 'is_cake')
