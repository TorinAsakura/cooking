...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('master_class_masterclass', 'category_id')

        # Deleting field 'MasterClass.subcategory'
        db.delete_column('master_class_masterclass', 'subcategory_id')

        # Adding M2M table for field category on 'MasterClass'
        db.create_table('master_class_masterclass_category', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('masterclass', models.ForeignKey(orm['master_class.masterclass'], null=False)),
            ('categorymc', models.ForeignKey(orm['master_class.categorymc'], null=False))
        ))
        db.create_unique('master_class_masterclass_category', ['masterclass_id', 'categorymc_id'])

        # Adding M2M table for field subcategory on 'MasterClass'
        db.create_table('master_class_masterclass_subcategory', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('masterclass', models.ForeignKey(orm['master_class.masterclass'], null=False)),
            ('subcategorymc', models.ForeignKey(orm['master_class.subcategorymc'], null=False))
        ))
        db.create_unique('master_class_masterclass_subcategory', ['masterclass_id', 'subcategorymc_id'])

    def backwards(self, orm):
        # Adding field 'MasterClass.category'
        db.add_column('master_class_masterclass', 'category',
        ...
        db.add_column('master_class_masterclass', 'subcategory',
        ...
        db.delete_table('master_class_masterclass_category')

        # Removing M2M table for field subcategory on 'MasterClass'
        db.delete_table('master_class_masterclass_subcategory')
    ...
    models = {
        ...
        'master_class.masterclass': {
            ...
            'category': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['master_class.CategoryMC']", 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'published': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50'}),
            'subcategory': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['master_class.SubCategoryMC']", 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'visits_num': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'})
        },
