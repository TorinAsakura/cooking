...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MCStep.note'
        db.add_column(u'master_class_mcstep', 'note',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MCStep.note'
        db.delete_column(u'master_class_mcstep', 'note')
    ...
    models = {
        ...
        u'master_class.mcstep': {
            ...
            'note': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True'}),
