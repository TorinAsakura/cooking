...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MasterClass.add_watermark'
        db.add_column('master_class_masterclass', 'add_watermark',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'MasterClass.add_watermark'
        db.delete_column('master_class_masterclass', 'add_watermark')
