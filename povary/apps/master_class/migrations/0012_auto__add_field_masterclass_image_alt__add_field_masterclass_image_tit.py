...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MasterClass.image_alt'
        db.add_column('master_class_masterclass', 'image_alt',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MasterClass.image_title'
        db.add_column('master_class_masterclass', 'image_title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'MasterClass.image_alt'
        db.delete_column('master_class_masterclass', 'image_alt')

        # Deleting field 'MasterClass.image_title'
        db.delete_column('master_class_masterclass', 'image_title')
