...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MasterClass.prepare_time_from'
        db.add_column(u'master_class_masterclass', 'prepare_time_from',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'MasterClass.prepare_time_to'
        db.add_column(u'master_class_masterclass', 'prepare_time_to',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'MasterClass.prepare_time_from'
        db.delete_column(u'master_class_masterclass', 'prepare_time_from')

        # Deleting field 'MasterClass.prepare_time_to'
        db.delete_column(u'master_class_masterclass', 'prepare_time_to')
