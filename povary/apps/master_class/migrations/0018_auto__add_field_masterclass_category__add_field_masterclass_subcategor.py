...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MasterClass.category'
        db.add_column(u'master_class_masterclass', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['master_class.CategoryMC'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'MasterClass.subcategory'
        db.add_column(u'master_class_masterclass', 'subcategory',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['master_class.SubCategoryMC'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field subcategory on 'MasterClass'
        db.delete_table(db.shorten_name(u'master_class_masterclass_subcategory'))

        # Removing M2M table for field category on 'MasterClass'
        db.delete_table(db.shorten_name(u'master_class_masterclass_category'))


    def backwards(self, orm):
        # Deleting field 'MasterClass.category'
        db.delete_column(u'master_class_masterclass', 'category_id')

        # Deleting field 'MasterClass.subcategory'
        db.delete_column(u'master_class_masterclass', 'subcategory_id')

        # Adding M2M table for field subcategory on 'MasterClass'
        m2m_table_name = db.shorten_name(u'master_class_masterclass_subcategory')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('masterclass', models.ForeignKey(orm[u'master_class.masterclass'], null=False)),
            ('subcategorymc', models.ForeignKey(orm[u'master_class.subcategorymc'], null=False))
        ))
        db.create_unique(m2m_table_name, ['masterclass_id', 'subcategorymc_id'])

        # Adding M2M table for field category on 'MasterClass'
        m2m_table_name = db.shorten_name(u'master_class_masterclass_category')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('masterclass', models.ForeignKey(orm[u'master_class.masterclass'], null=False)),
            ('categorymc', models.ForeignKey(orm[u'master_class.categorymc'], null=False))
        ))
        db.create_unique(m2m_table_name, ['masterclass_id', 'categorymc_id'])
    ...
    models = {
        ...
        u'master_class.masterclass': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['master_class.CategoryMC']", 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'is_cake': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'prepare_time_from': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'prepare_time_to': ('django.db.models.fields.PositiveIntegerField', [], {'default': '200'}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'published': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50'}),
            'subcategory': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['master_class.SubCategoryMC']", 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'visits_num': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'})
        },
