...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CategoryMC.description'
        db.add_column('master_class_categorymc', 'description',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'SubCategoryMC.description'
        db.add_column('master_class_subcategorymc', 'description',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'CategoryMC.description'
        db.delete_column('master_class_categorymc', 'description')

        # Deleting field 'SubCategoryMC.description'
        db.delete_column('master_class_subcategorymc', 'description')
