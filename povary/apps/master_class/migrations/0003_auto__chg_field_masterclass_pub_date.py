...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MasterClass.pub_date'
        db.alter_column('master_class_masterclass', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'MasterClass.pub_date'
        raise RuntimeError("Cannot reverse this migration. 'MasterClass.pub_date' and its values cannot be restored.")
    models = {
        'auth.group': {
