...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CategoryMC.slug'
        db.add_column('master_class_categorymc', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', unique=True, max_length=50),
                      keep_default=False)

        # Adding field 'SubCategoryMC.slug'
        db.add_column('master_class_subcategorymc', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', unique=True, max_length=50),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'CategoryMC.slug'
        db.delete_column('master_class_categorymc', 'slug')

        # Deleting field 'SubCategoryMC.slug'
        db.delete_column('master_class_subcategorymc', 'slug')
