...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MasterClass.ip_addr'
        db.add_column('master_class_masterclass', 'ip_addr',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'MasterClass.ip_addr'
        db.delete_column('master_class_masterclass', 'ip_addr')
