...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WikiPageVersion.reason'
        db.add_column('wiki_wikipageversion', 'reason',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WikiPageVersion.reason'
        db.delete_column('wiki_wikipageversion', 'reason')
