...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WikiPageVersion.user'
        db.delete_column('wiki_wikipageversion', 'user_id')

        # Adding field 'WikiPageVersion.author'
        db.add_column('wiki_wikipageversion', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'WikiPageVersion.user'
        raise RuntimeError("Cannot reverse this migration. 'WikiPageVersion.user' and its values cannot be restored.")
        # Deleting field 'WikiPageVersion.author'
        db.delete_column('wiki_wikipageversion', 'author_id')
