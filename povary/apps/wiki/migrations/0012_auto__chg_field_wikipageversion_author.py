...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WikiPageVersion.author'
        db.alter_column('wiki_wikipageversion', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'WikiPageVersion.author'
        raise RuntimeError("Cannot reverse this migration. 'WikiPageVersion.author' and its values cannot be restored.")
