...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WikiPageVersion.status'
        db.add_column('wiki_wikipageversion', 'status',
                      self.gf('django.db.models.fields.CharField')(default='0', max_length=255),
                      keep_default=False)

        # Adding field 'WikiPageVersion.ip_addr'
        db.add_column('wiki_wikipageversion', 'ip_addr',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'WikiPageVersion.status'
        db.delete_column('wiki_wikipageversion', 'status')

        # Deleting field 'WikiPageVersion.ip_addr'
        db.delete_column('wiki_wikipageversion', 'ip_addr')
