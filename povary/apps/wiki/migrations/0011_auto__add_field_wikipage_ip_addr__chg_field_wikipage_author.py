...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WikiPage.ip_addr'
        db.add_column('wiki_wikipage', 'ip_addr',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


        # Changing field 'WikiPage.author'
        db.alter_column('wiki_wikipage', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):
        # Deleting field 'WikiPage.ip_addr'
        db.delete_column('wiki_wikipage', 'ip_addr')


        # User chose to not deal with backwards NULL issues for 'WikiPage.author'
        raise RuntimeError("Cannot reverse this migration. 'WikiPage.author' and its values cannot be restored.")
    ...
    models = {
        ...
        'wiki.wikidiscussion': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'wiki_discussions'", 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
