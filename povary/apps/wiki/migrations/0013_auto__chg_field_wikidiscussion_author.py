...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WikiDiscussion.author'
        db.alter_column('wiki_wikidiscussion', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'WikiDiscussion.author'
        raise RuntimeError("Cannot reverse this migration. 'WikiDiscussion.author' and its values cannot be restored.")
