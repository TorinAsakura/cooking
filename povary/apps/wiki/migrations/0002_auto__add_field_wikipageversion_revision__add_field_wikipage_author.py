...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WikiPageVersion.revision'
        db.add_column('wiki_wikipageversion', 'revision',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'WikiPage.author'
        db.add_column('wiki_wikipage', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'WikiPageVersion.revision'
        db.delete_column('wiki_wikipageversion', 'revision')

        # Deleting field 'WikiPage.author'
        db.delete_column('wiki_wikipage', 'author_id')
