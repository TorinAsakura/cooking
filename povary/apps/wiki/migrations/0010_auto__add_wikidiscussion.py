...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WikiDiscussion'
        db.create_table('wiki_wikidiscussion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('version', self.gf('django.db.models.fields.related.ForeignKey')(related_name='discussions', to=orm['wiki.WikiPageVersion'])),
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='wiki_discussions', to=orm['auth.User'])),
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('wiki', ['WikiDiscussion'])


    def backwards(self, orm):
        # Deleting model 'WikiDiscussion'
        db.delete_table('wiki_wikidiscussion')
