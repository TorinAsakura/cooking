...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field redactors on 'WikiPage'
        db.create_table('wiki_wikipage_redactors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('wikipage', models.ForeignKey(orm['wiki.wikipage'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('wiki_wikipage_redactors', ['wikipage_id', 'user_id'])

    def backwards(self, orm):
        # Removing M2M table for field redactors on 'WikiPage'
        db.delete_table('wiki_wikipage_redactors')
