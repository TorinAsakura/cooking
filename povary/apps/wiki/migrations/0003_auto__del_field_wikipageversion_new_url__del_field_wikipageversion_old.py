...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WikiPageVersion.new_url'
        db.delete_column('wiki_wikipageversion', 'new_url')

        # Deleting field 'WikiPageVersion.old_url'
        db.delete_column('wiki_wikipageversion', 'old_url')

        # Adding field 'WikiPageVersion.old_slug'
        db.add_column('wiki_wikipageversion', 'old_slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=50),
                      keep_default=False)

        # Adding field 'WikiPageVersion.new_slug'
        db.add_column('wiki_wikipageversion', 'new_slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=50),
                      keep_default=False)

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'WikiPageVersion.new_url'
        raise RuntimeError("Cannot reverse this migration. 'WikiPageVersion.new_url' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'WikiPageVersion.old_url'
        raise RuntimeError("Cannot reverse this migration. 'WikiPageVersion.old_url' and its values cannot be restored.")
        # Deleting field 'WikiPageVersion.old_slug'
        db.delete_column('wiki_wikipageversion', 'old_slug')

        # Deleting field 'WikiPageVersion.new_slug'
        db.delete_column('wiki_wikipageversion', 'new_slug')
