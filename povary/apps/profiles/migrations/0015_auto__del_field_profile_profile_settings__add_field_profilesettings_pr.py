...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProfileSettings.profile'
        db.add_column('profiles_profilesettings', 'profile',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['profiles.Profile'], unique=True, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ProfileSettings.profile'
        db.delete_column('profiles_profilesettings', 'profile_id')
    ...
    models = {
        ...
        'profiles.profilesettings': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['profiles.Profile']", 'unique': 'True', 'null': 'True'}),
