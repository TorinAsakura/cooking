...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('profiles_profile', 'status', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Profile.status'
        raise RuntimeError("Cannot reverse this migration. 'Profile.status' and its values cannot be restored.")
    models = {
        'auth.group': {
