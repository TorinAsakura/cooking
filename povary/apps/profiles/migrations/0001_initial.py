...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('profiles_profile', (
            ...
            ('vk_link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('about', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('cookery_in_life', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('cook', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('cake_master', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('grade', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
