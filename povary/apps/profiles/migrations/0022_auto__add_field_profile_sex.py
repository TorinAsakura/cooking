...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'profiles_profile', 'sex',
                      self.gf('django.db.models.fields.CharField')(default='male', max_length=6, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.sex'
        db.delete_column(u'profiles_profile', 'sex')
