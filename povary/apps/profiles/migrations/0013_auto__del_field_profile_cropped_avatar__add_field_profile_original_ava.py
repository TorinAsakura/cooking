...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.cropped_avatar'
        db.delete_column('profiles_profile', 'cropped_avatar')

        # Adding field 'Profile.original_avatar'
        db.add_column('profiles_profile', 'original_avatar',
                      self.gf('filebrowser.fields.FileBrowseField')(max_length=255, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Profile.cropped_avatar'
        db.add_column('profiles_profile', 'cropped_avatar',
                      self.gf('filebrowser.fields.FileBrowseField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Profile.original_avatar'
        db.delete_column('profiles_profile', 'original_avatar')
