...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('profiles_awardcategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('profiles', ['AwardCategory'])

        # Adding model 'AssignedAward'
        db.create_table('profiles_assignedaward', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('award', self.gf('django.db.models.fields.related.ForeignKey')(related_name='assigned_awards', to=orm['profiles.Award'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='awards', to=orm['auth.User'])),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('profiles', ['AssignedAward'])

        # Adding field 'Award.description'
        db.add_column('profiles_award', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Award.category'
        db.add_column('profiles_award', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['profiles.AwardCategory']),
                      keep_default=False)

        # Adding field 'Award.is_active'
        db.add_column('profiles_award', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'Award.title'
        db.alter_column('profiles_award', 'title', self.gf('django.db.models.fields.CharField')(default=1, max_length=255))

        # Changing field 'Award.icon'
        db.alter_column('profiles_award', 'icon', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
    ...
    def backwards(self, orm):
        ...
        db.delete_table('profiles_awardcategory')

        # Deleting model 'AssignedAward'
        db.delete_table('profiles_assignedaward')

        # Deleting field 'Award.description'
        db.delete_column('profiles_award', 'description')

        # Deleting field 'Award.category'
        db.delete_column('profiles_award', 'category_id')

        # Deleting field 'Award.is_active'
        db.delete_column('profiles_award', 'is_active')


        # Changing field 'Award.title'
        db.alter_column('profiles_award', 'title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Award.icon'
        db.alter_column('profiles_award', 'icon', self.gf('filebrowser.fields.FileBrowseField')(max_length=255))
    ...
    models = {
        ...
        'profiles.assignedaward': {
            'Meta': {'object_name': 'AssignedAward'},
            'award': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'assigned_awards'", 'to': "orm['profiles.Award']"}),
        ...
        'profiles.award': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['profiles.AwardCategory']"}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
