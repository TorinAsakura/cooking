...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.last_login_ip'
        db.alter_column('profiles_profile', 'last_login_ip', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Profile.registration_ip'
        db.alter_column('profiles_profile', 'registration_ip', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    def backwards(self, orm):

        # Changing field 'Profile.last_login_ip'
        db.alter_column('profiles_profile', 'last_login_ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True))

        # Changing field 'Profile.registration_ip'
        db.alter_column('profiles_profile', 'registration_ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True))
    models = {
        'auth.group': {
