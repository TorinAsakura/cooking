...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.avatar_img'
        db.add_column('profiles_profile', 'avatar_img',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Profile.avatar_img'
        db.delete_column('profiles_profile', 'avatar_img')
    ...
    models = {
        ...
        'profiles.profile': {
            ...
            'avatar_img': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
