...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.comments_num'
        db.add_column(u'articles_article', 'comments_num',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.comments_num'
        db.delete_column(u'articles_article', 'comments_num')
    ...
    models = {
        u'articles.article': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'articles'", 'to': u"orm['articles.ArticleCategory']"}),
            'comments_num': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
