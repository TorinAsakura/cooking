...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArticleCategory.add_watermark'
        db.add_column('articles_articlecategory', 'add_watermark',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Article.add_watermark'
        db.add_column('articles_article', 'add_watermark',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ArticleCategory.add_watermark'
        db.delete_column('articles_articlecategory', 'add_watermark')

        # Deleting field 'Article.add_watermark'
        db.delete_column('articles_article', 'add_watermark')
