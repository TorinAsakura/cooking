...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('articles_article', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'Article.pub_date'
        db.alter_column('articles_article', 'pub_date', self.gf('django.db.models.fields.DateTimeField')())
    def backwards(self, orm):
        ...
        # Changing field 'Article.pub_date'
        db.alter_column('articles_article', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
    models = {
        'articles.article': {
