...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ArticleCategory.image'
        db.alter_column('articles_articlecategory', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ArticleCategory.image'
        raise RuntimeError("Cannot reverse this migration. 'ArticleCategory.image' and its values cannot be restored.")
