...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArticleCategory.visits_num'
        db.add_column('articles_articlecategory', 'visits_num',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Article.visits_num'
        db.add_column('articles_article', 'visits_num',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ArticleCategory.visits_num'
        db.delete_column('articles_articlecategory', 'visits_num')

        # Deleting field 'Article.visits_num'
        db.delete_column('articles_article', 'visits_num')
