...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArticleCategory.image_alt'
        db.add_column('articles_articlecategory', 'image_alt',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ArticleCategory.image_title'
        db.add_column('articles_articlecategory', 'image_title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ArticleCategory.image_alt'
        db.delete_column('articles_articlecategory', 'image_alt')

        # Deleting field 'ArticleCategory.image_title'
        db.delete_column('articles_articlecategory', 'image_title')
