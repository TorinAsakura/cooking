...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArticleCategory.image'
        db.add_column('articles_articlecategory', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'Article.image'
        db.add_column('articles_article', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ArticleCategory.image'
        db.delete_column('articles_articlecategory', 'image')

        # Deleting field 'Article.image'
        db.delete_column('articles_article', 'image')
