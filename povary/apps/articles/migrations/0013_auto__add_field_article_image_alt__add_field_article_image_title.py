...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.image_alt'
        db.add_column('articles_article', 'image_alt',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Article.image_title'
        db.add_column('articles_article', 'image_title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Article.image_alt'
        db.delete_column('articles_article', 'image_alt')

        # Deleting field 'Article.image_title'
        db.delete_column('articles_article', 'image_title')
