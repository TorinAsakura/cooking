...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetitionPrizes.image'
        db.add_column(u'competitions_competitionprizes', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompetitionPrizes.image'
        db.delete_column(u'competitions_competitionprizes', 'image')
