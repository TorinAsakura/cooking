...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CompetitionRequest'
        db.create_table('competitions_competitionrequest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('competition', self.gf('django.db.models.fields.related.ForeignKey')(related_name='requests', to=orm['competitions.Competition'])),
        ...
        db.send_create_signal('competitions', ['CompetitionRequest'])

    def backwards(self, orm):
        # Deleting model 'CompetitionRequest'
        db.delete_table('competitions_competitionrequest')
    ...
    models = {
        ...
        'competitions.competitionrequest': {
            ...
            'competition': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'requests'", 'to': "orm['competitions.Competition']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
