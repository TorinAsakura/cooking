...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CompetitionSponsors'
        db.create_table(u'competitions_competitionsponsors', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('competition', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sponsors', to=orm['competitions.Competition'])),
        ))
        db.send_create_signal(u'competitions', ['CompetitionSponsors'])


    def backwards(self, orm):
        # Deleting model 'CompetitionSponsors'
        db.delete_table(u'competitions_competitionsponsors')
