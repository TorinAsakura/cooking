...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CompetitionPrizes'
        db.create_table(u'competitions_competitionprizes', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('place', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('competition', self.gf('django.db.models.fields.related.ForeignKey')(related_name='prizes', to=orm['competitions.Competition'])),
        ))
        db.send_create_signal(u'competitions', ['CompetitionPrizes'])

        # Adding unique constraint on 'CompetitionPrizes', fields ['competition', 'place']
        db.create_unique(u'competitions_competitionprizes', ['competition_id', 'place'])

        # Deleting field 'Competition.prizes'
        db.delete_column(u'competitions_competition', 'prizes')

        # Adding unique constraint on 'CompetitionTermStep', fields ['competition', 'step_num']
        db.create_unique(u'competitions_competitiontermstep', ['competition_id', 'step_num'])


    def backwards(self, orm):
        # Removing unique constraint on 'CompetitionTermStep', fields ['competition', 'step_num']
        db.delete_unique(u'competitions_competitiontermstep', ['competition_id', 'step_num'])

        # Removing unique constraint on 'CompetitionPrizes', fields ['competition', 'place']
        db.delete_unique(u'competitions_competitionprizes', ['competition_id', 'place'])

        # Deleting model 'CompetitionPrizes'
        db.delete_table(u'competitions_competitionprizes')

        # Adding field 'Competition.prizes'
        db.add_column(u'competitions_competition', 'prizes',
                      self.gf('django.db.models.fields.TextField')(default=datetime.datetime(2013, 12, 21, 0, 0)),
                      keep_default=False)
    ...
    models = {
        ...
        u'competitions.competitionprizes': {
            'Meta': {'ordering': "('competition',)", 'unique_together': "(('competition', 'place'),)", 'object_name': 'CompetitionPrizes'},
        ...
        u'competitions.competitiontermstep': {
            'Meta': {'ordering': "('competition',)", 'unique_together': "(('competition', 'step_num'),)", 'object_name': 'CompetitionTermStep'},
