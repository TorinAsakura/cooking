...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetitionRequest.place_number'
        db.add_column('competitions_competitionrequest', 'place_number',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompetitionRequest.place_number'
        db.delete_column('competitions_competitionrequest', 'place_number')
