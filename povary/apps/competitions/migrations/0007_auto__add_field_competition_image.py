...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'competitions_competition', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(default=datetime.datetime(2013, 12, 16, 0, 0), max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Competition.image'
        db.delete_column(u'competitions_competition', 'image')
