...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CompetitionCategory'
        db.create_table('competitions_competitioncategory', (
        ...
        db.send_create_signal('competitions', ['CompetitionCategory'])
        ...
        db.create_table('competitions_competition', (
            ...
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['competitions.CompetitionCategory'])),
            ('prizes', self.gf('django.db.models.fields.TextField')()),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='competitions', to=orm['auth.User'])),
    ...
    def backwards(self, orm):
        # Deleting model 'CompetitionCategory'
        db.delete_table('competitions_competitioncategory')
