...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GalleryImage.author'
        db.add_column('gallery_galleryimage', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'GalleryImage.author'
        db.delete_column('gallery_galleryimage', 'author_id')
