...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Notice.is_question'
        db.add_column(u'notifications_notice', 'is_question',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Notice.is_question'
        db.delete_column(u'notifications_notice', 'is_question')
