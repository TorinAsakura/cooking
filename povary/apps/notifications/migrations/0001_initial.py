...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Notice'
        db.create_table(u'notifications_notice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('from_name', self.gf('django.db.models.fields.CharField')(default='\xd0\x90\xd0\xb4\xd0\xbc\xd0\xb8\xd0\xbd\xd0\xb8\xd1\x81\xd1\x82\xd1\x80\xd0\xb0\xd1\x86\xd0\xb8\xd1\x8f', max_length=255)),
        ...
        db.send_create_signal(u'notifications', ['Notice'])


    def backwards(self, orm):
        # Deleting model 'Notice'
        db.delete_table(u'notifications_notice')
