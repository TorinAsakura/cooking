...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # db.add_column('events_event', 'country',
        #               self.gf('django.db.models.fields.related.ForeignKey')(to=orm['regions.Country'], null=True, blank=True),
        #               keep_default=False)
        #
        # # Adding field 'Event.city'
        # db.add_column('events_event', 'city',
        #               self.gf('django.db.models.fields.related.ForeignKey')(to=orm['regions.City'], null=True, blank=True),
        #               keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # db.delete_column('events_event', 'country_id')
        #
        # # Deleting field 'Event.city'
        # db.delete_column('events_event', 'city_id')
