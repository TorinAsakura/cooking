...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'events.event': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'events'", 'to': u"orm['events.EventCategory']"}),
            'city': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'events'", 'null': 'True', 'to': u"orm['cities_light.City']"}),
            'country': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'events'", 'null': 'True', 'to': u"orm['cities_light.Country']"}),
            ...
            'is_cook': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
