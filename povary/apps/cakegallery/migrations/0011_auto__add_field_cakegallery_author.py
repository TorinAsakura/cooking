...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CakeGallery.author'
        db.add_column(u'cakegallery_cakegallery', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CakeGallery.author'
        db.delete_column(u'cakegallery_cakegallery', 'author_id')
