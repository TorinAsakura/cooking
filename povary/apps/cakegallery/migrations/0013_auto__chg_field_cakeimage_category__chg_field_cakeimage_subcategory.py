...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CakeImage.category'
        db.alter_column(u'cakegallery_cakeimage', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['cakegallery.CakeCategory']))

        # Changing field 'CakeImage.subcategory'
        db.alter_column(u'cakegallery_cakeimage', 'subcategory_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['cakegallery.CakeSubCategory']))

    def backwards(self, orm):

        # Changing field 'CakeImage.category'
        db.alter_column(u'cakegallery_cakeimage', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['cakegallery.CakeCategory']))

        # Changing field 'CakeImage.subcategory'
        db.alter_column(u'cakegallery_cakeimage', 'subcategory_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['cakegallery.CakeSubCategory']))
    ...
    models = {
        ...
        u'cakegallery.cakeimage': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'images'", 'null': 'True', 'to': u"orm['cakegallery.CakeCategory']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'published': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50'}),
            'subcategory': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'images'", 'null': 'True', 'to': u"orm['cakegallery.CakeSubCategory']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'visits_num': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'})
        },
