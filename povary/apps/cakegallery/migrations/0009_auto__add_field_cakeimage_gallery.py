...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'cakegallery_cakeimage', 'gallery',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='gallery', null=True, to=orm['gallery.Gallery']),
                      keep_default=False)
    ...
    models = {
        ...
        u'cakegallery.cakeimage': {
            ...
            'gallery': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'gallery'", 'null': 'True', 'to': u"orm['gallery.Gallery']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('sorl.thumbnail.fields.ImageField', [], {'max_length': '100'}),
