...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CakeGallery.slug'
        db.add_column(u'cakegallery_cakegallery', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CakeGallery.slug'
        db.delete_column(u'cakegallery_cakegallery', 'slug')
